...
func TestQuickSortAsc(t *testing.T) {
	sorted := Quick([]int{10, 23423, 444, -77, 1231231, 11, 0}, true)
	assert.Equal(t, []int{-77, 0, 10, 11, 444, 23423, 1231231}, sorted)
}

func TestQuickSortDesc(t *testing.T) {
	sorted := Quick([]int{-1, 10, math.MaxInt32, 0, 7, math.MinInt32, math.MinInt8, 1231231, 11, 0, 11, 1, 100, 13, 1, 5}, false)
